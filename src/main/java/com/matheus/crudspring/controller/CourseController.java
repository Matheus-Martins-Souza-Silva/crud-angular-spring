...
import com.matheus.crudspring.service.CourseService;
...
public class CourseController {
    ...
    @GetMapping
    public CoursePageDTO list(@RequestParam(defaultValue = "0") @PositiveOrZero int page,  @RequestParam(defaultValue = "10") @Positive @Max(value = 100) int pageSize) {
