...
import com.matheus.crudspring.dto.LessonDTO;
...
public class CourseMapper {
    ...
    public CourseDTO toDto(Course course) {
        ...
        List<LessonDTO> lessons = course.getLessons().stream().map(lesson -> new LessonDTO(lesson.getId(), 
        lesson.getName(), 
        lesson.getYoutubeUrl())).collect(Collectors.toList());
